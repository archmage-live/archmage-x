...
// App
export const isExtensionApp: boolean = process.env.PLASMO_PUBLIC_IS_ARCHMAGE_EXTENSION === 'true'
export const isMobileApp: boolean = false
export const isWebApp: boolean = process.env.NEXT_PUBLIC_IS_ARCHMAGE_WEB === 'true'
