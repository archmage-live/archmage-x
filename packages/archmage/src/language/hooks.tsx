...
import { Language, Locale, mapLanguageToLocale } from '@/archmage/language/constants'
import { atomWithLocalStore, storeKey } from '@/archmage/store'

const CURRENT_LANGUAGE_KEY = storeKey('currentLanguage')

const currentLanguageAtom = atomWithLocalStore(CURRENT_LANGUAGE_KEY, Language.English)

export function useCurrentLanguage() {
  return useAtom(currentLanguageAtom)
}
 ...
 */
export function useCurrentLocale(): Locale | undefined {
  const [currentLanguage] = useCurrentLanguage()
  return currentLanguage ? getLocale(currentLanguage) : undefined
}
...
export function useCurrentLanguageInfo(): LanguageInfo | undefined {
  const [currentLanguage] = useCurrentLanguage()
  return currentLanguage ? getLanguageInfo(currentLanguage) : undefined
}
