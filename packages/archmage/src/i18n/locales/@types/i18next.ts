import 'packages/archmage/src/i18n/locales/@types/i18next'
...
import Resources from '@/archmage/i18n/locales/@types/resources'

interface CustomResources {
  translation: Resources['en-US']
}

declare module 'packages/archmage/src/i18n/locales/@types/i18next' {
